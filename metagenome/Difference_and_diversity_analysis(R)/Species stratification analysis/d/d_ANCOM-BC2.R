...
# ----------------------------
otu_files <- list(
  virus = "E:/Python/MI_Analysis/metagenome/data_figures/p/门水平.xlsx"
)

metadata_file = "E:/Python/MI_Analysis/metagenome/data_figures/p/sample_metadata.xlsx"

# 输出文件夹
output_dir <- "E:/Python/MI_Analysis/metagenome/data_figures/p/ancombc2_results_new/"
...
for (microbe in names(otu_files)) {
  ...
  rownames(feature_data) <- feature_data$门
