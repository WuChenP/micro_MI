...
# ----------------------------
otu_files <- list(
  virus = "E:/Python/MI_Analysis/metagenome/data_figures/c/纲水平.xlsx"
)

metadata_file = "E:/Python/MI_Analysis/metagenome/data_figures/c/sample_metadata.xlsx"

# 输出文件夹
output_dir <- "E:/Python/MI_Analysis/metagenome/data_figures/c/ancombc2_results_new/"
...
for (microbe in names(otu_files)) {
  ...
  rownames(feature_data) <- feature_data$纲
