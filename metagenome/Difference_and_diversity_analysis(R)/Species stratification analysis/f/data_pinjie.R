...
file2_path <- "E:/Python/MI_Analysis/metagenome/data_figures/f/ancombc2_results_new/virus_ANCOMBC2_results.xlsx"
output_path <- "E:/Python/MI_Analysis/metagenome/data_figures/f/f_ANCOM-BC2_merged_result.xlsx"
