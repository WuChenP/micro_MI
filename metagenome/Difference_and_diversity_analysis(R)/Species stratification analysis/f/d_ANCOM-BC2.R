...
# ----------------------------
otu_files <- list(
  virus = "E:/Python/MI_Analysis/metagenome/data_figures/f/科水平.xlsx"
)

metadata_file = "E:/Python/MI_Analysis/metagenome/data_figures/f/sample_metadata.xlsx"

# 输出文件夹
output_dir <- "E:/Python/MI_Analysis/metagenome/data_figures/f/ancombc2_results_new/"
...
for (microbe in names(otu_files)) {
  ...
  rownames(feature_data) <- feature_data$科
