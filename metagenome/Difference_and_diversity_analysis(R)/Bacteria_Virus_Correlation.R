...
# 设置工作目录和文件路径
base_path <- "E:/Python/MI_Analysis/metagenome/Absolute_abundance_analysis/Layered_host_viral_data_differential_bacterial_mixture_analysis1"
setwd(base_path)
