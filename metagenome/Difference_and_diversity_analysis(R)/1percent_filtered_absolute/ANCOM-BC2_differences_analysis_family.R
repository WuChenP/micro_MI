# ============================
# ANCOM-BC2 family水平分析（去掉无法计算的行，只保留 Family 列）
# ============================
...
# 输出文件夹
output_dir <- "E:/Python/MI_Analysis/metagenome/Absolute_abundance_analysis/filtered_data_1percent/ancombc2_results_family/"
...
rownames(metadata) <- metadata$SampleID  # 样本 ID 对应行名
