...
# 输入文件
input_file <- "E:/Python/MI_Analysis/metagenome/data_figures/filtered_data/ancombc2_results/four_microbes_with_abundance.xlsx"

# 输出目录
outdir <- "E:/Python/MI_Analysis/metagenome/data_figures/filtered_data/ancombc2_results/split_by_microbe/"
